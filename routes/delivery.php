...
Route::prefix('delivery')->middleware(['auth'])->group(function () {
        ...
        Route::get('/delivery-challan/{id}/dispatch', [DeliveryChallanController::class, 'dispatchPage'])
            ->name('Delivery_challan.dispatch_page');
        
        Route::post('/delivery-challan/{id}/dispatch', [DeliveryChallanController::class, 'dispatchStore'])
            ->name('Delivery_challan.dispatch_store');
    ...
    Route::get('/{id}/print', [DispatchController::class, 'print'])
        ->name('dispatch.print');
